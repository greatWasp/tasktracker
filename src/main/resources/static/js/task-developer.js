...
function loadTask(){
    $.get("http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName, function(response, status){
        task = response;
        $.get("http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName + "/comments", function(response, status){
...
function saveComment(commentId, commentText){
    ...
    $.ajax({
        url: "http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName + "/comments/edit",
        type: "PUT",
...
function deleteComment(){
    $.ajax({
        url: "http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName + "/comments/delete/" + $(this).data("id"),
        type: "DELETE",
        success: function () {
            location.reload();
        }
...
function createComment(){
    ...
    $.post({
        url: "http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName + "/comments/create",
        type: "post",
        data: JSON.stringify(commentDto),
        dataType: "json",
        contentType: "application/json"
...
$("#save-status").click(function(){
    ...
    $.ajax({
        url: "http://localhost:8080/api/developer/projects/" + projectName + "/tasks/" + taskName + "/status/edit",
        type: "PUT",
        contentType: "application/json",
        dataType: "json",
